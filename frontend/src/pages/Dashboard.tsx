  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="overflow-hidden rounded-2xl glass px-4 py-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 sm:p-6 animate-slide-up" style={{ animationDelay: '0ms' }}>
        ...
        <div className="overflow-hidden rounded-2xl glass px-4 py-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 sm:p-6 animate-slide-up" style={{ animationDelay: '100ms' }}>
        ...
        <div className="overflow-hidden rounded-2xl glass px-4 py-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 sm:p-6 animate-slide-up" style={{ animationDelay: '200ms' }}>
        ...
        <div className="overflow-hidden rounded-2xl glass px-4 py-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 sm:p-6 animate-slide-up" style={{ animationDelay: '300ms' }}>
      ...
      <div className="rounded-2xl glass p-6 animate-slide-up" style={{ animationDelay: '400ms' }}>
